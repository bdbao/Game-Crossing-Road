...
const float CCONSTANT::GENERAL_DELAY_SOUND = 1.f;
const float CCONSTANT::DELAY_WALKING_SOUND = 0.375f;
const float CCONSTANT::DELAY_CAR_SOUND = 3.0f;
const float CCONSTANT::DELAY_REINDEER_SOUND = 4.0f;
const float CCONSTANT::DELAY_BULL_SOUND = 3.25f;
const float CCONSTANT::DELAY_PENGUIN_SOUND = 3.f;
